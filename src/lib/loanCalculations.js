...
export const QUOTES = [
  ...
  { text: "Shigeru Miyamoto designed worlds where rules could be broken. Design a life where debt cannot.", author: "Shigeru Miyamoto, Nintendo" },
  { text: "I wanted to create something that nobody had seen before. That's also what your financial freedom should be.", author: "Shigeru Miyamoto (adapted)" },
  ...
  { text: "Billy Mitchell's Donkey Kong record stood for years because he didn't quit. Your zero balance will too.", author: "Billy Mitchell, Arcade Champion" },
  { text: "Twin Galaxies verified records were sacred. Verify your own financial records.", author: "Twin Galaxies, Video Game History" },
  ...
  { text: "The speedrun community says: optimize everything, skip the filler, get to the goal. Apply that to money.", author: "Speedrunning Philosophy (adapted)" },
  { text: "Starcraft pros trained like athletes. Train like your money is at stake — because it is.", author: "Starcraft Esports (adapted)" },
  { text: "The Sega Genesis was the underdog that beat Nintendo. Debt is the giant you beat.", author: "Sega vs. Nintendo (adapted)" },
  { text: "Sega's strategy: be different, be fast, be better. Your financial strategy should mirror it.", author: "Sega (1990s)" },
  { text: "The Game Boy had worse graphics than competition but won because of systems thinking. Think like Game Boy.", author: "Nintendo Game Boy (adapted)" },
  ...
  { text: "Sonic the Hedgehog was fast because speed was the point. Make progress your point.", author: "Sonic (adapted)" },
  ...
  { text: "Gradius taught us: adapt your loadout to the stage. Adapt your strategy to your loans.", author: "Gradius (adapted)" },
  { text: "Metroid taught us: explore, find power-ups, become stronger. That's debt payoff.", author: "Metroid (adapted)" },
  { text: "Mario Kart taught us: sometimes luck matters, but skill always wins long-term.", author: "Mario Kart (adapted)" },
  { text: "Kirby's superpower is absorption. Absorb knowledge about your money.", author: "Kirby (adapted)" },
  { text: "Earthbound taught us: weird, unconventional paths can win. Your payoff doesn't have to look standard.", author: "Earthbound (adapted)" },
  { text: "Fire Emblem: permadeath means every choice matters. Every financial choice matters.", author: "Fire Emblem (adapted)" },
  { text: "Civilization taught us: build slowly, play the long game, win by systems.", author: "Civilization (adapted)" },
  { text: "The Sims taught us: small daily habits compound into entire lives. Good or bad.", author: "The Sims (adapted)" },
  ...
  { text: "Perfect Dark advanced the genre because it went deeper. Go deeper into your debt strategy.", author: "Perfect Dark (adapted)" },
  { text: "Mega Man boss defeats teach pattern recognition. Your loan patterns are readable.", author: "Mega Man (adapted)" },
  { text: "Battletoads was brutal but fair: learn the patterns, beat the stage. Same with debt.", author: "Battletoads (adapted)" },
];
