...
export const QUOTE_GROUPS = [
  ...
  { id: 'kardashians', label: 'The Kardashians', filter: q => q.author?.includes('Kardashian') || q.author?.includes('Kylie Jenner') || q.author?.includes('Rihanna') || q.author?.includes('Lizzo') },
