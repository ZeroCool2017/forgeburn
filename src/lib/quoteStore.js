...
export const QUOTE_GROUPS = [
  ...
  { id: 'music', label: 'Music (Radiohead, Pavement, etc.)', filter: q => ['Radiohead','Pavement','Built to Spill','Tracy Chapman','Kacey Musgraves','Dolly Parton','Charly Crockett','Cardi B','Future','Grimes'].some(a => q.author?.includes(a)) },
